'   Class Name:      cFTCKoPDB 
'   Author:          Keith Moore     
'   Date:            November 2016 
'   Description:     The object provides connection services to the Frog Force FTC Kit of Parts Database. 
'                    The database is the MySQL database hosted at Go Daddy.com  
'   Change history:
'
Imports MySql.Data.MySqlClient

Public Class cFTCKoPDB
    ...
    Public Function GetConnection() As MySqlConnection
        ...
        'sConn = "DSN=FFWebsite" & ";"
        sConn = "server=50.62.209.111;User ID=FFAdmin;Password=17@Frog01;Database=FTCKoP;pooling=False"
